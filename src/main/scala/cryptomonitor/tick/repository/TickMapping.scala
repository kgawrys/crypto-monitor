...
class TickMapping(tag: Tag) extends Table[Tick](tag, "ticks") {
  ...
  def priceUsd: Rep[Option[BigDecimal]]         = column("price_usd")
  def priceBtc: Rep[Option[BigDecimal]]         = column("price_btc")
  def volumeUsd24h: Rep[Option[BigDecimal]]     = column("volume_usd_24h")
  ...
  def percentChange1h: Rep[Option[BigDecimal]]  = column("percent_change_1h")
  def percentChange24h: Rep[Option[BigDecimal]] = column("percent_change_24h")
  def percentChange7d: Rep[Option[BigDecimal]]  = column("percent_change_7d")
  def lastUpdated: Rep[Option[Instant]]         = column("last_updated")
